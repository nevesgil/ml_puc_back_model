...
class SpaceshipModel:
    def __init__(self, model_path):
        ...
        self.destination_mapping = {'TRAPPIST-1e': 1, 'PSO J318.5-22': 2, '55 Cancri e': 3}
    ...
    def map_inputs(self, home_planet, cryo_sleep, destination, age, vip, total_spend):
        ...
        return np.array([[home_planet_value, cryo_sleep_value, destination_value, age, vip_value, total_spend]])
